const dishes = [
    { keyword: 'gaspacho', name: 'Гаспачо', price: 195, category: 'soup', count: '350 г', image: 'gazpacho.jpg', kind: 'вегетарианский' },
    ...
    { keyword: 'chicken', name: 'Куриный суп', price: 330, category: 'soup', count: '350 г', image: 'chicken.jpg', kind: 'мясной' },
    ...
    { keyword: 'friedpotatoeswithmushrooms1', name: 'Жареная картошка с грибами', price: 150, category: 'main_course', count: '250 г', image: 'friedpotatoeswithmushrooms.jpg', kind: 'вегетарианское' },
    { keyword: 'lasagna', name: 'Лазанья', price: 385, category: 'main_course', count: '310 г', image: 'lasagna.jpg', kind: 'мясное' },
    { keyword: 'pizza', name: 'Пицца Маргарита', price: 450, category: 'main_course', count: '470 г', image: 'pizza.jpg', kind: 'вегетарианское' },
    ...
    { keyword: 'cappuccino', name: 'Капучино', price: 180, category: 'beverages', count: '300 мл', image: 'cappuccino.jpg', kind: 'горячий' },
    { keyword: 'applejuice', name: 'Яблочный сок', price: 90, category: 'beverages', count: '300 мл', image: 'applejuice.jpg', kind: 'холодный' },
    { keyword: 'caesar', name: 'Цезарь с цыплёнком', price: 370, category: 'salads_starters', count: '220 г', image: 'caesar.jpg', kind: 'мясной' },
    { keyword: 'caprese', name: 'Капрезе с моцарелой', price: 350, category: 'salads_starters', count: '235 г', image: 'caprese.jpg', kind: 'вегетарианский' },
    ...
    { keyword: 'frenchfries2', name: 'Картофель фри с кетчупом', price: 260, category: 'salads_starters', count: '235 г', image: 'frenchfries2.jpg', kind: 'вегетарианский' },
    ...
    { keyword: 'chocolatecheesecake', name: 'Шоколадный чизкейк', price: 260, category: 'desserts', count: '125 г', image: 'chocolatecheesecake.jpg', kind: 'маленькая порция' },
